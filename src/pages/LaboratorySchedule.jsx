import "./LaboratorySchedule.scss";
import Sidebar from "../Sidebar.jsx";
import Navbar from "../navbar.jsx";
import { useState } from "react";

function LaboratorySchedule() {
    const [selectedDay, setSelectedDay] = useState("Monday/Wednesday");

    const renderTable = () => {
        switch (selectedDay) {
            case "Monday/Wednesday":
                return <MondayAndWednesdayS />;
            case "Tuesday/Thursday":
                return <TuesdayAndThursdayS />;
            case "Friday":
                return <FridayS />;
            case "Saturday":
                return <SaturdayS />;
